...
export const metadata: Metadata = {
  title: "Private Mind Sync - Encrypted Goal Management",
  description: "Secure goal management with Fully Homomorphic Encryption",
  icons: {
    icon: '/Private Mind Sync-logo.svg',
    shortcut: '/Private Mind Sync-logo.svg',
    apple: '/Private Mind Sync-logo.svg',
  },
};
          ...
          <main className="flex flex-col max-w-screen-xl mx-auto pb-20 px-4 md:px-6">
            <nav className="flex w-full h-fit py-6 md:py-8 justify-between items-center mb-4">
              <div className="flex items-center gap-3">
                <Image
                  src="/Private Mind Sync-logo.svg"
                  alt="Private Mind Sync Logo"
                  width={60}
                  height={60}
